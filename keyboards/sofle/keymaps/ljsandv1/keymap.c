 ...
 * `-----------------------------------------/       /    \       \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | / Bspc  /      \ Enter \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /        \       \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_ESC,     KC_Z,    KC_X,    KC_C,      KC_V,          KC_B,    KC_MUTE,
 ...
 * |  ESC |   #  |   &  |  {   |   }  |  <   |-------|    |-------|   >  |   1  |   2  |  3   |   /  | RSFT |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | / BSPC  /       \Enter \  |RAISE | 0    | .    | $    |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_SYMNUM] = LAYOUT(
  _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        KC_F6,  KC_F7,  KC_F8,   KC_F9,  KC_F10,  KC_F11,
  _______, KC_PERC,   KC_AT, KC_LBRC, KC_RBRC, KC_CIRC,                      KC_PLUS,  KC_P7,  KC_P8,   KC_P9, KC_ASTR,  KC_F12,
  _______, KC_EXLM,  KC_EQL, KC_LPRN, KC_RPRN, KC_UNDS,                      KC_MINS,  KC_P4,  KC_P5,   KC_P6, KC_PIPE, KC_BSLS,
...
// Stole encoder code from the sofle rgb_default keymap,
// but changed final return to false to prevent default encoder behavior
